...
export const JOKER_CATALOG: Readonly<Record<JokerId, JokerDefinition>> = {
  "zero-day": {
    id: "zero-day",
    name: "제로 데이",
    description: "득점 카드에 0이 있으면 +1 배수",
    rarity: "common",
    price: 4,
  },
  redline: {
    id: "redline",
    name: "레드라인",
    description: "득점한 빨강 카드마다 +3 칩 (최대 +15)",
    rarity: "common",
    price: 4,
  },
  "blue-buffer": {
    id: "blue-buffer",
    name: "블루 버퍼",
    description: "파랑 카드가 2장 이상 득점하면 +10 칩",
    rarity: "common",
    price: 4,
  },
  "green-loop": {
    id: "green-loop",
    name: "그린 루프",
    description: "같은 숫자가 2장 이상 득점하면 +8 칩",
    rarity: "common",
    price: 4,
  },
  "yellow-ticket": {
    id: "yellow-ticket",
    name: "옐로 티켓",
    description: "라운드 첫 핸드에 노랑 득점 카드가 있으면 1코인 획득",
    rarity: "common",
    price: 4,
  },
  "odd-signal": {
    id: "odd-signal",
    name: "홀수 신호",
    description: "득점한 홀수 카드마다 +2 칩 (최대 +10)",
    rarity: "common",
    price: 4,
  },
  "even-signal": {
    id: "even-signal",
    name: "짝수 신호",
    description: "득점한 짝수 카드마다 +2 칩 (최대 +10, 0 포함)",
    rarity: "common",
    price: 4,
  },
  "cache-hit": {
    id: "cache-hit",
    name: "캐시 히트",
    description: "이번 라운드에 이미 사용한 족보라면 +1 배수",
    rarity: "common",
    price: 4,
  },
  "splash-mode": {
    id: "splash-mode",
    name: "스플래시 모드",
    description: "제출한 모든 카드의 숫자 칩을 계산",
    rarity: "uncommon",
    price: 6,
  },
  "spectrum-analyzer": {
    ...
    name: "스펙트럼 분석기",
    description: "득점 카드에 4색이 모두 있으면 +10 칩, +1 배수",
    rarity: "uncommon",
    price: 6,
  },
  "monochrome-monitor": {
    ...
    name: "단색 모니터",
    description: "플러시 계열 족보에 +10 칩, +1 배수",
    rarity: "uncommon",
    price: 6,
  },
  ...
  "spare-battery": {
    id: "spare-battery",
    name: "예비 배터리",
    description: "남은 버리기마다 +5 칩 (최대 +15)",
    rarity: "uncommon",
    price: 6,
  },
  "last-commit": {
  ...
  "version-control": {
    id: "version-control",
    name: "버전 관리",
    description: "직전 핸드와 다른 족보면 +12 칩",
    rarity: "uncommon",
    price: 6,
  },
  "cmyk-core": {
    id: "cmyk-core",
    name: "CMYK 코어",
    description: "득점 카드에 4색이 모두 있으면 최종 점수 ×1.30",
    rarity: "rare",
    price: 8,
  },
  "combo-compiler": {
    id: "combo-compiler",
    name: "콤보 컴파일러",
    description: "서로 다른 족보 연속 사용마다 ×0.08 (최대 ×1.32)",
    rarity: "rare",
    price: 8,
  },
  "hot-swap": {
    id: "hot-swap",
    name: "핫 스왑",
    description: "선택한 색 득점 카드의 숫자 칩을 한 번 더 계산",
    rarity: "rare",
    price: 8,
  },
  "null-pointer": {
    id: "null-pointer",
    name: "널 포인터",
    description: "0이 2장 이상 득점하면 최종 점수 ×1.35",
    rarity: "rare",
    price: 8,
  },
};
