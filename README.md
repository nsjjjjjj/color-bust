...
현재 코드는 게임 규칙, 5 STAGE·무한 모드, GARAGE, MOD 20종, 카드 개조·팩, 커뮤니티 MAYHEM 제작, 로그인 기반 클라우드 저장, 랭킹, 평가용 방명록, PWA 오프라인 실행까지 연결되어 있습니다.
...
- 공식 MOD 20종, MOD 슬롯 4칸
- POWER·HYPE·MAYHEM의 세 성장 축과 카드별 MOD 연쇄 점수 연출
- 덱 카드 제거·복제·색/숫자 변경, 충전·증폭·민트 특수효과
- CIRCUIT/GLITCH 팩에서 3장 공개 후 1장 선택
- 보상 명세 확인·직접 수령 후 5개 구역으로 나뉜 GARAGE 진입
- MOD 구매·판매, GARAGE 진열 갱신, 패턴 레벨 강화
...
숫자 카드의 회로 프레임은 `public/art/deck-mayhem-card-frame-v1.png`를 사용하고 숫자·배지는 HTML로 선명하게 겹쳐 표시합니다. 다음 컴포넌트에서 카드 표현을 관리합니다.
